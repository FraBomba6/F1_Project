...
## Occorenze per stato
```{r country_occurrence, message=FALSE}
...
Come pronosticabile le prime due posizioni sono occupate da Schumaker e da Hamilton. In questa classifica Hamilton ha vinto anche la stagione corrente in base alle gare fino ad ora disputate, se dovesse avere delle prestazioni simili a quelle della scorsa stagione passerebbe ad essere il migliore pilota di sempre della F1